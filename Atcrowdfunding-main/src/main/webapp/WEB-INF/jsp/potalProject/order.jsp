                                ...
                                <div class="col-md-12 column">
                                    <div class="alert alert-warning alert-dismissable" style="text-align:right; border:2px solid #ffc287;">
                                        <ul style="list-style:none;" >
                                            ...
                                            <li style="margin-top:10px;">
                                                <button id="payBtn" type="button" class="btn btn-success btn-lg" onclick="window.location.href='pay-step-3.html'"><i class="glyphicon glyphicon-credit-card"></i> 立即付款</button>
                                            </li>
                                           <%-- <li style="margin-top:10px;">
                                                <div class="checkbox">
                                                    <label>
...
<script>
   ...
   /* //动态给立即付款添加不可点属性
    $("#knowRoleCheckBox").click(function () {
        ...
        if (status) {
            $("#payBtn").prop("disabled","");   //移除disable属性
        }else {
            $("#payBtn").prop("disabled","disabled") //添加disable属性
        }
    });*/
