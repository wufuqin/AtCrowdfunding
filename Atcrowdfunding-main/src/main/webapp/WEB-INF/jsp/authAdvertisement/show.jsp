                ...
                <div class="panel-body">
                    <div class="panel-body">
                        <form>
                            ...
                            <button onclick="passAdvertisement()" type="button" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> 通过</button>
                            <button onclick="refuseAdvertisement()" type="button" class="btn btn-danger"><i class="glyphicon glyphicon-refresh"></i> 拒绝</button>
                        </form>
                    </div>
                </div>
            </div>
