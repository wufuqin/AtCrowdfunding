...
<script type="text/javascript">
    $(function () {
        ...
        showMenu();
        queryPageAuthAdvertisement(0);
    });
</script>

<%--查询需要审核的广告数据--%>
<script>
    function queryPageAuthAdvertisement(pageIndex) {
        $.ajax({
            type : "POST",
            data : {
                "pageno" : pageIndex + 1,
            ...
            url : "${APP_PATH}/authAdvertisement/doIndex.do",
            beforeSend : function () {
            ...
            success : function (result) {
                ...
                if (result.success){
                    ...
                    $("#Pagination").pagination(page.totalsize, {
                        ...
                        callback: queryPageAuthAdvertisement, //当前函数
...
<%-- 模糊查询 （目前没有实现）--%>
<script>
    function queryPageAuthAdvertisementLike(pageIndex) {
        $.ajax({
            type : "POST",
            data : {
                "pageno" : pageIndex + 1,
            ...
            url : "${APP_PATH}/authAdvertisement/doLike.do",
            beforeSend : function () {
                loadingIndex = layer.msg('数据加载中...', {icon: 16});
                return true;
            },
            success : function (result) {
                ...
                if (result.success){
                    ...
                    $("#Pagination").pagination(page.totalsize, {
                        num_edge_entries: 2, //边缘页数
                        num_display_entries: 4, //主体页数
                        callback: queryPageAuthAdvertisementLike, //当前函数
                        items_per_page:8, //每页显示多少条
                        current_page :(page.pageno-1), //当前页
                        prev_text : "上一页",
                        next_text : "下一页"
