...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
   <%-- <div class="container">
        <div class="navbar-header">
            <div><a class="navbar-brand" href="${APP_PATH}/index.htm" style="font-size:32px;">随机抽签系统</a></div>
        </div>
    </div>--%>
...
<div class="container">
    <form id="loginForm" class="form-signin" role="form">
        <h2 class="form-signin-heading"><i class="glyphicon glyphicon-log-in"></i> 随机抽签</h2>
        <div class="form-group has-success has-feedback">
            <input type="text" class="form-control" id="loginacct" name="loginacct" placeholder="请输入学号" autofocus>
        </div>
        <div class="form-group has-success has-feedback">
            <input type="password" class="form-control" id="userpswd" name="userpswd" placeholder="请输入姓名" style="margin-top:10px;">
        </div>
       ...
       <%-- <div class="form-group has-success has-feedback">
        ...
        <a class="btn btn-lg btn-success btn-block" onclick="dologin()" > 查看抽签结果</a>
    </form>
</div>
